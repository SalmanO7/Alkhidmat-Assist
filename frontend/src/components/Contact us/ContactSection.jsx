...
function ContactSection() {
  ...
  return (
    <>
      <div className="flex flex-col  overflow-x-hidden md:flex-row mt-10 items-center justify-center">
        <form className="w-full px-2  max-w-lg md:w-1/2 md:mr-5">
          ...
          <Textarea placeholder="Message" className=" border border-black mb-4  h-44 rounded-lg" />
          
          <div className="flex justify-center">
            <button
              onClick={handleSubmit}
              className="w-32 sm:w-44 sm:max-w-44 lg:max-w-[250px] bg-blue-500 h-11 border border-black rounded-xl font-bold text-white text-lg 
  hover:bg-blue-400 transition duration-300">
        ...
        {/* Map Section */}
        <div className="flex justify-center  mt-10 mx-2      md:mt-0">
          <img className="w-full md:w-[560px] mx-7 " src={map} alt="Map" />
        </div>
      </div>
      <div class="my-6 sm:max-w-[90%] lg:max-w-4xl max-w-screen-md max-w-3xl mx-auto p-4">
  <h1 class="text-xl sm:text-2xl font-bold text-center mb-6">Want To Contact Us?</h1>

  <div class="flex flex-wrap justify-between items-center gap-6 md:gap-10 pt-3">

    <div class="flex items-center space-x-2 w-full sm:w-auto">
      <img class="w-12" src={location} alt="Location Icon" />
      <span class="text-lg">Alkhidmat Foundation Headoffice</span>
    </div>
