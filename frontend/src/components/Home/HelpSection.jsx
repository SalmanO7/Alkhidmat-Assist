  ...
  return (
    ...
    <section className="flex sm:justify-around sm:items-center flex-col justify-center items-center px-3   sm:flex-row lg:px-10 2xl:px-24 pt-[100px]">
      <div className="flex flex-col sm:justify-start sm::items-start xl:gap-5 lg:gap-4 md:gap-3 sm:gap-2 gap-4  pl-10">
        <h2 className="text-2xl md:text-4xl lg:text-3xl xl:text-5xl font-bold">
        ...
        <div className="py-2">
          <a href="#" className="border-2 border-[#00529B] text-[#00529B] font-bold py-2 px-8">
            Lear More
          </a>
        </div>
      </div>{""}
      <div className="p-10 sm:pr-6 md:pr-10 sm:w-[900px] md:w-[1000px] lg:w-[1000px] 2xl:w-3/4">
